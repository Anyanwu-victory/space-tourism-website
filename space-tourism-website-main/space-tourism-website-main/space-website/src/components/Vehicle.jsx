      ...
      <>
        <div className=" text-white overflow-hidden">
          ...
          <div className="h-screen max-w-full relative flex justify-center ">
            <div className="absolute mt-[9rem] text-center lg:flex">
              <div className=" md:mt-[3.9rem] lg:hidden md:hidden">
                <img src={vehicle} className=" h-[18rem] w-[100%] object-cover " alt="launch vehicle" />
              </div>
              ...
              <div className="lg:mt-[9rem] lg:text-start ">
                ...
                <div className="pb-[6rem] mt-[2rem]">
                   ...
                   <button
                      key={index}
                       type="button"
                       className={`w-10 h-10 rounded-full  ${currentSlide === index ? 'bg-[#ffffff]' : 'bg-[transparent] border border-white '}`}
                      aria-current={currentSlide === index ? 'true' : 'false'}
                      value={` text-black ${index}}`}
