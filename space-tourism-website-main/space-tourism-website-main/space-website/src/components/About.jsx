  ...
  return (
    <div className='text-center px-[] '>
       ...
       <div className='relative w-full h-screen'>
        ...
        <h1 className=" text-white text-center text-[97px] font-[bellefair] text-400 lg:text-300 lg:text-[130px]"> SPACE</h1>

        <p className="font-[barlow] text-[20px] text-center leading-[32px] mx-[2rem] font-thin pt-[15px]  lg:">Let’s face it; if you want to go to space, you might as well genuinely go to 
         ...
         font-[bellefair] py-[5rem] mx-[160px] my-[2.9rem] '>
