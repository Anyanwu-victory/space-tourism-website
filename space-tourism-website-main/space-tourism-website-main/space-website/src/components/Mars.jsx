...
const  Carousel = ()  => { 
  ...
  <>
        ...
        <h1 className=" text-white text-center text-[90px] font-[bellefair] 
          text-400 uppercase  lg:text-start lg:pl-[1.6rem]">mars </h1>
  ...
  const Mars = ({data}) => {
    ...
    return (
      <>
        ...
        <div className='max-h-screen max-w-full relative flex justify-center lg:overflow-hidden '>
