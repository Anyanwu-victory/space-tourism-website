  ...
  return (
    <>
        ...
        <div className=" h-[304px] overflow-hidden md:h-[680px]">
          {[...Array(4).keys()].map((slide, index) => (
            ...
            `translateX(${index * 100}%)` }}>
              <img src={europa} className=" block w-[200px] h-[200px] object-cover" alt={`Slide ${index + 1}`} />
      ...
      <div className='text-white  mt-[-14px]'>
        <h1 className=" text-white text-center text-[90px] font-[bellefair] text-400 uppercase ">europa</h1>
